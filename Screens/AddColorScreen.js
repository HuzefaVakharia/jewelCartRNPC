...
const route = useRoute();
    ...
    const { 
    accessTokenSentToAddColorScreen,
    previousScreenName,
...
//alert('Name of supplier is:'+name+'State name is:'+state+' State ID is:'+stateWithID+' City name is:'+city+' City ID is:'+cityWithID);
  ...
  const [
    callFetchDynamicAPIsInAddColorScreen,
    setcallFetchDynamicAPIsInAddColorScreen,
  ] = useState(false);
  ...
  let [caratnameInAddColorScreen, setCaratNameInAddColorScreen] = useState('');

  let [colornameInAddColorScreen, setColorNameInAddColorScreen] = useState('');

const [selectedCaratFromListInAddColorScreen, setselectedCaratFromListInAddColorScreen] = useState('Carat');
let [selectedCaratIDInAddColorScreen, setselectedCaratIDInAddColorScreen] = useState(-1);    


  

  const chkAllFieldsEnteredInAddColorScreen = () => {
    ...
    //colornameInAddColorScreen
    

    setcallFetchDynamicAPIsInAddColorScreen(true);
  ...
  /*  useEffect(() => {
    alert(
     ...
     //alert('Name of supplier is:'+caratnameInAddColorScreen+'State name is:'+stateInAddColorScreen+' State ID is:'+stateIDInAddColorScreen+' City name is:'+cityInAddColorScreen+' City ID is:'+cityIDInAddColorScreen); 
  }, []);*/     
                ...
                {/*Our UI in Card starts here  */}
                    ...
                    <View>
                      ...
                      <AnimatedTextInputFile
                        ...
                        accessTokenprops={accessTokenSentToAddColorScreen}
                        startprops={'0'}
                        limitprops={'100000'}
                        state_idprops={'545'}
                        city_idprops={'454'}
                        ...
                        selectedCaratListFromListProps={ selectedCaratFromListInAddColorScreen }
                        setselectedCaratListFromListProps={ setselectedCaratFromListInAddColorScreen }    
                        

                        setselectedCaratIDFromListProps={setselectedCaratIDInAddColorScreen}
                        selectedCaratIDFromListProps={selectedCaratIDInAddColorScreen}
                    ...
                    <TextInput
                      ...
                      label="Color Name"
                      mode="outlined"
                      value={colornameInAddColorScreen}
                      onChangeText={(value) =>
                        setColorNameInAddColorScreen(value)
                      }
                      theme={{
                        ...
                        <Button
                          ...
                          onPress={() => {
                           setIsUpdateProcessRunning(true);
                            ...
                            chkAllFieldsEnteredInAddColorScreen();
                          }}
                    ...
                    {callFetchDynamicAPIsInAddColorScreen == true ? (       
                      
                      
                      <FetchDynamicAPIs
                        urlToFetchProps={'manage_color'}
                        screenNameProps={'AddColorScreen'}
                        accessTokenForFetchingAPIProps={
                          accessTokenSentToAddColorScreen
                        }
                        //accessTokenForFetchingAPIProps={''}
                        caratIDProps={selectedCaratIDInAddColorScreen}
                        colorToBeEditedProps={colornameInAddColorScreen}
                        actionProps={'add'}
                        setloaderActiviteOrNotProps={setIsUpdateProcessRunning}       
                        gotoColorScreenAfterAddProps={gotoColorScreen} 
                        callFetchDynamicAPIsInAddColorScreenprops={callFetchDynamicAPIsInAddColorScreen}
                        setcallFetchDynamicAPIsInAddColorScreenprops={setcallFetchDynamicAPIsInAddColorScreen}
                      />
