...
const route = useRoute();
    ...
    const { 
    accessTokenSentToAddCategoryScreen,
    previousScreenName,
...
//alert('Name of supplier is:'+name+'State name is:'+state+' State ID is:'+stateWithID+' City name is:'+city+' City ID is:'+cityWithID);
  ...
  const [
    callFetchDynamicAPIsInAddCategoryScreen,
    setcallFetchDynamicAPIsInAddCategoryScreen,
  ] = useState(false);
  ...
  let [categorynameInAddCategoryScreen, setCategoryNameInAddCategoryScreen] = useState('');

  

  

  const chkAllFieldsEnteredInAddCategoryScreen = () => {
    if (!categorynameInAddCategoryScreen.trim()) {
    ...
    setcallFetchDynamicAPIsInAddCategoryScreen(true);
  ...
  /*  useEffect(() => {
    alert(
     ...
     //alert('Name of supplier is:'+categorynameInAddCategoryScreen+'State name is:'+stateInAddCategoryScreen+' State ID is:'+stateIDInAddCategoryScreen+' City name is:'+cityInAddCategoryScreen+' City ID is:'+cityIDInAddCategoryScreen); 
  }, []);*/     
      ...
      bounces={false}>
                ...
                {/*Our UI in Card starts here  */}
                  <TextInput
                      ...
                      label="Category Name"
                      mode="outlined"
                      value={categorynameInAddCategoryScreen}
                      onChangeText={(value) =>
                        setCategoryNameInAddCategoryScreen(value)
                      }
                      theme={{
                        ...
                        <Button
                          ...
                          onPress={() => {
                           setIsUpdateProcessRunning(true);
                            ...
                            chkAllFieldsEnteredInAddCategoryScreen();
                          }}
                    ...
                    {callFetchDynamicAPIsInAddCategoryScreen == true ? (       
                      
                      
                      <FetchDynamicAPIs
                        urlToFetchProps={'manage_category'}
                        screenNameProps={'AddCategoryScreen'}
                        accessTokenForFetchingAPIProps={
                          accessTokenSentToAddCategoryScreen
                        }
                        //accessTokenForFetchingAPIProps={''}
                        categoryNameProps={categorynameInAddCategoryScreen}
                        //categoryIDToBeEditedProps={categoryIDToBeEdited}
                        actionProps={'add'}
                        setloaderActiviteOrNotProps={setIsUpdateProcessRunning}       
                        gotoCategoryScreenAfterAddProps={gotoCategoryScreen} 
                        callFetchDynamicAPIsInAddCategoryScreenprops={callFetchDynamicAPIsInAddCategoryScreen}
                        setcallFetchDynamicAPIsInAddCategoryScreenprops={setcallFetchDynamicAPIsInAddCategoryScreen}
                      />
