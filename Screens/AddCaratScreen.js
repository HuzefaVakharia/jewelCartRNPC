...
const AddCaratScreen = ({navigation }) => {
const route = useRoute();
  

    const { 
    accessTokenSentToAddCaratScreen,
    previousScreenName,
...
//alert('Name of supplier is:'+name+'State name is:'+state+' State ID is:'+stateWithID+' City name is:'+city+' City ID is:'+cityWithID);
  ...
  const [
    callFetchDynamicAPIsInAddCaratScreen,
    setcallFetchDynamicAPIsInAddCaratScreen,
  ] = useState(false);
  ...
  let [caratnameInAddCaratScreen, setCaratNameInAddCaratScreen] = useState('');

  

  

  const chkAllFieldsEnteredInAddCaratScreen = () => {
    if (!caratnameInAddCaratScreen.trim()) {
    ...
    setcallFetchDynamicAPIsInAddCaratScreen(true);
  ...
  /*  useEffect(() => {
    alert(
     ...
     //alert('Name of supplier is:'+caratnameInAddCaratScreen+'State name is:'+stateInAddCaratScreen+' State ID is:'+stateIDInAddCaratScreen+' City name is:'+cityInAddCaratScreen+' City ID is:'+cityIDInAddCaratScreen); 
  }, []);*/     

  const gotoCategoryScreen = () => {
    alert('going to Category Screen....');
     navigation.replace("CaratScreen", {     
      accessTokenSentToCaratScreen: accessTokenSentToAddCaratScreen,
      ...
      bounces={false}>
                ...
                {/*Our UI in Card starts here  */}
                  <TextInput
                      ...
                      label="Carat"
                      mode="outlined"
                      value={caratnameInAddCaratScreen}
                      onChangeText={(value) =>
                        setCaratNameInAddCaratScreen(value)
                      }
                      theme={{
                        ...
                        <Button
                          ...
                          onPress={() => {
                           setIsUpdateProcessRunning(true);
                            ...
                            chkAllFieldsEnteredInAddCaratScreen();
                          }}
                    ...
                    {callFetchDynamicAPIsInAddCaratScreen == true ? (       
                      
                      
                      <FetchDynamicAPIs
                        urlToFetchProps={'manage_carat'}
                        screenNameProps={'AddCaratScreen'}
                        accessTokenForFetchingAPIProps={
                          accessTokenSentToAddCaratScreen
                        }
                        //accessTokenForFetchingAPIProps={''}
                        caratNameProps={caratnameInAddCaratScreen}
                        //categoryIDToBeEditedProps={categoryIDToBeEdited}
                        actionProps={'add'}
                        setloaderActiviteOrNotProps={setIsUpdateProcessRunning}       
                        gotoCaratScreenAfterAddProps={gotoCategoryScreen} 
                        callFetchDynamicAPIsInAddCaratScreenprops={callFetchDynamicAPIsInAddCaratScreen}
                        setcallFetchDynamicAPIsInAddCaratScreenprops={setcallFetchDynamicAPIsInAddCaratScreen}
                      />
